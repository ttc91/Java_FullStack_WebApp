...
@RestController
@RequestMapping(ApiPath.apiDomain + ApiPath.statusDomain)
public class StatusController {
	...
	public ResponseEntity<ResponseDto<BaseDto>> insert(@RequestBody StatusDto request){
	...
	public ResponseEntity<ResponseDto<BaseDto>> update (@RequestBody StatusDto request, @PathVariable("id") Integer id){
