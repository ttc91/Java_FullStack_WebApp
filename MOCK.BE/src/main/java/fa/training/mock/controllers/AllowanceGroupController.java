...
@RestController
@RequestMapping(ApiPath.apiDomain + ApiPath.allowanceGroupDomain)
public class AllowanceGroupController {
	@Autowired
	AllowanceGroupService service;

	@PostMapping(ApiPath.insertDomain)
	public ResponseEntity<ResponseDto<BaseDto>> insert(@RequestBody AllowanceGroupDto request) {
	...
	public ResponseEntity<ResponseDto<BaseDto>> update(@RequestBody AllowanceGroupDto request,
			@PathVariable("id") Integer id) {

		try {
			request.setAllowanceGroupId(id);
	...
	public ResponseEntity<ResponseDto<BaseDto>> delete(@PathVariable("id") Integer id) {
		...
		try {
			AllowanceGroupDto dto = new AllowanceGroupDto();
			dto.setAllowanceGroupId(id);
