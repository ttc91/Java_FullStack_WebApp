...
@RestController
@RequestMapping(ApiPath.apiDomain + ApiPath.ChannelDomain)
public class ChannelController {
	...
	public ResponseEntity<ResponseDto<BaseDto>> insert(@RequestBody ChannelDto request) {
		try {
	...
	public ResponseEntity<ResponseDto<BaseDto>> update(@RequestBody ChannelDto request,
